...
public class JettyFactory {
	...
	public static Server createServerInSource(int port, String contextPath) {
		...
		webContext2.setContextPath("/re");
		webContext2.setResourceBase("C:/www");
		webContext2.addServlet("org.eclipse.jetty.servlet.DefaultServlet",
				"/re");
		HandlerList h = new HandlerList();
		h.addHandler(webContext);
		h.addHandler(webContext2);
