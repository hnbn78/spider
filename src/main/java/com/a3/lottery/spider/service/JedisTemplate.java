...
public class JedisTemplate {
	...
	public static final int EXPIRE_TIME_5MIN = 5 * 60;

	public static final int EXPIRE_TIME_30MIN = 30 * 60;

	public static final int EXPIRE_TIME_60MIN = 60 * 60;
	...
	public Void batchHincryBy(final String key, final Map<String, Long> map) {
		return execute(new JedisAction<Void>() {

			@Override
			public Void action(Jedis jedis) {
				Pipeline pipline = jedis.pipelined();
				for (Entry<String, Long> entry : map.entrySet()) {
					pipline.hincrByFloat(key, entry.getKey(), entry.getValue());
				}
				pipline.sync();
				return null;
			}
	...
	public Void batchHincryByDouble(final String key, final Map<String, Double> map) {
		return execute(new JedisAction<Void>() {
	...
	private static class JedisUtils {
